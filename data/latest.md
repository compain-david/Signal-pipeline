...
Generated 2026-08-31T18:46:11.087953+00:00 · schema v4
...
- **10-dimension (AUTHORITATIVE):** 3 of 7 fired, threshold 5 → would not fire
  - grade **C** — watch - some evidence, below the historical bar (3.0 of 6.6 achievable this run)
  - reading: mixed: 2 rotation, 1 froth
  - not counted: eth_etf_flows, alt_funding_rates
...
|---|---|---|---|---|---|
| eth_btc_momentum | 1 | A | 6.17 | no | live |
| btc_dominance | 1 | track | 59.22 | no | live |
| alt_dominance | 1 | track | 29.63 | — | FAILED (building) |
...
| alt_funding_rates | 7 | A | 4.12 | — | live |
